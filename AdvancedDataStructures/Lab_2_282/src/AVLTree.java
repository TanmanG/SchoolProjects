public class AVLTree<E> extends BST<E> {
   ...
   private void balanceRR(TreeNode<E> A, TreeNode<E> parentOfA) {
     // Left as exercise
     TreeNode<E> C = A.right; // A is left-heavy and B is left-heavy
     ...
     A.right = C.left; // Make T2 the left subtree of A
     C.left = A; // Make A the left child of B
     updateHeight((AVLTreeNode<E>)A);
     updateHeight((AVLTreeNode<E>)C);
   }
   ...
   private void balanceRL(TreeNode<E> A, TreeNode<E> parentOfA) {
     // Left as exercise
     TreeNode<E> C = A.right; // A is left-heavy
     TreeNode<E> B = C.left; // B is right-heavy
     ...
     A.right = B.left; // Make T3 the left subtree of A
     C.left = B.right; // Make T2 the right subtree of B
     B.right = C;
     B.left = A;
